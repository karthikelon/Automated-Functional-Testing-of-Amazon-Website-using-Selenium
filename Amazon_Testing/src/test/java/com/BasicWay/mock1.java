...
public class mock1 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// login in to amazon 
				System.setProperty("webdriver.chrome.driver", "C:\\Users\\LENOVO\\eclipse-workspace\\Amazon_Testing\\src\\test\\resources\\chromedriver.exe");
				...
				driver.findElement(By.xpath("//input[@id='twotabsearchtextbox']")).sendKeys("peanut butter 1_kg ");
				driver.findElement(By.xpath("//input[@id='nav-search-submit-button']")).click();
				
				

				// Scroll until target product is found
		        WebElement targetProduct = driver.findElement(By.xpath("//span[contains(text(),'Sundrop Peanut Butter')]"));
		        scrollIntoView(driver, targetProduct);
		        
		        // Clicking on the target product
		        targetProduct.click();
		...
		driver.switchTo().defaultContent();
		    ...
		    // Function to scroll into view of a WebElement
